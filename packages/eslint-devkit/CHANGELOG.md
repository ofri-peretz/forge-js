...
- Improved type guards for AST node checking
...
This is the first stable major release of `@interlace/eslint-devkit`, marking the package as production-ready with a stable API.
