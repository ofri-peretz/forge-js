  ...
  describe('resolveWithExternalResolvers', () => {
    it('should return null when settings is null', () => {
      const result = resolveWithExternalResolvers(
        'react',
        '/path/to/file.ts',
        null as unknown as ResolverSetting,
      );
    ...
    it('should return null when settings is undefined', () => {
      const result = resolveWithExternalResolvers(
        'react',
        '/path/to/file.ts',
        undefined as unknown as ResolverSetting,
      );
      expect(result).toBeNull();
    });
    ...
    it('should cache resolver loading', () => {
      // First call
      const result1 = resolveWithExternalResolvers(
        'react',
        '/path/to/file.ts',
        'test-resolver-1',
      );
      ...
      const result2 = resolveWithExternalResolvers(
        'react',
        '/path/to/file.ts',
        'test-resolver-1',
      );
