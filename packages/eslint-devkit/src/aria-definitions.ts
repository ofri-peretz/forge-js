...
export const ROLE_SUPPORTED_ARIA_PROPS: Record<string, Set<string>> = {
  ...
  checkbox: new Set(['aria-checked', 'aria-required']),
  columnheader: new Set(['aria-expanded', 'aria-selected', 'aria-sort']),
  combobox: new Set([
    'aria-expanded',
    'aria-required',
    'aria-activedescendant',
  ...
  gridcell: new Set(['aria-expanded', 'aria-selected', 'aria-readonly']),
  ...
  menu: new Set(['aria-expanded', 'aria-orientation', 'aria-activedescendant']),
  menubar: new Set([
    'aria-expanded',
    'aria-orientation',
    'aria-activedescendant',
  ]),
  menuitem: new Set(['aria-expanded']),
  ...
  row: new Set(['aria-expanded', 'aria-selected', 'aria-level']),
  rowheader: new Set(['aria-expanded', 'aria-sort']),
  scrollbar: new Set([
    'aria-controls',
    'aria-orientation',
    'aria-valuemax',
  ...
  tab: new Set(['aria-selected']),
  table: new Set(['aria-expanded', 'aria-colcount', 'aria-rowcount']),
  tablist: new Set([
    'aria-expanded',
    'aria-level',
    'aria-multiselectable',
  ...
  treeitem: new Set(['aria-expanded', 'aria-level', 'aria-selected']),
};
