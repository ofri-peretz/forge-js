# @interlace/eslint-devkit - AI Agent Guide

## Package Overview

**Name:** @interlace/eslint-devkit  
**Version:** 1.4.0  
...
**Directory:** packages/eslint-devkit
...
# or
pnpm add -D @interlace/eslint-devkit
# or
yarn add -D @interlace/eslint-devkit
```
...
```typescript
import { formatLLMMessage } from '@interlace/eslint-devkit';
...
- **Documentation:** https://github.com/ofri-peretz/forge-js/blob/main/packages/eslint-devkit/README.md
