/**
 * Node.js path utilities for ESLint rules
 *
 * These utilities handle path operations needed by rules like
 * no-circular-dependencies. They are extracted here to enable direct
 * unit testing without needing RuleTester.
 *
 * @coverage
 * This module is tested directly with node-path-utils.test.ts.
 */
 ...
 *
 * @example
 * formatCycleDisplay(['/proj/a.ts', '/proj/b.ts'], '/proj')
 * // Returns: 'a.ts ⟷ b.ts'
 *
 * formatCycleDisplay(['/proj/a.ts', '/proj/b.ts', '/proj/c.ts'], '/proj')
 * // Returns: 'a.ts → b.ts → c.ts → a.ts'
 */
 ...
 *
 * @example
 * getModuleNames(['/proj/src/utils.ts', '/proj/src/helpers.ts'], '/proj')
 * // Returns: ['utils', 'helpers']
 *
 * getModuleNames(['/proj/src/utils/index.ts'], '/proj')
 * // Returns: ['utils']
 */
 ...
 *
 * @example
 * getRelativeImportPath('/proj/src/a.ts', '/proj/src/b.ts')
 * // Returns: './b'
 *
 * getRelativeImportPath('/proj/src/dir/a.ts', '/proj/src/b.ts')
 * // Returns: '../b'
 */
