/**
 * Comprehensive tests for node-path-utils.ts
 *
...
describe('node-path-utils', () => {
  ...
  describe('isBarrelExport', () => {
    ...
    it('should return true for index.tsx', () => {
      ...
      expect(isBarrelExport('/project/components/Button/index.tsx', barrels)).toBe(true);
    });
  ...
  describe('formatCycleDisplay', () => {
    ...
    it('should handle empty array', () => {
      ...
      // Empty array produces undefined in join, which becomes 'undefined → undefined'
