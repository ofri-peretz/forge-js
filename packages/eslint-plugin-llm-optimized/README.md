...
| **Package Name**              | ✅ Descriptive, self-explanatory         | ⚠️ Generic names               |
...
> This package (`eslint-plugin-llm-optimized`) re-exports `@forge-js/eslint-plugin-llm-optimized` with a descriptive, unscoped name.
...
| [enforce-import-order](https://github.com/ofri-peretz/forge-js/blob/main/packages/eslint-plugin/docs/rules/enforce-import-order.md)                         | Enforce specific import order                    |     | ⚠️  | 🔧  | 💡  |
