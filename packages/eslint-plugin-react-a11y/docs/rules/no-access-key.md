...
> **Keywords:** no-access-key, accessibility, ESLint rule, WCAG, a11y, React accessibility

Prevent accessKey attribute usage. This rule is part of [`eslint-plugin-react-a11y`](https://www.npmjs.com/package/eslint-plugin-react-a11y) and provides LLM-optimized error messages with fix suggestions.
...
This rule helps ensure WCAG 2.1.1 compliance by enforcing: Prevent accessKey attribute usage
...
- **2.1.1 Keyboard**: Prevent accessKey attribute usage
