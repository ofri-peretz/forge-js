...
Prevent keyboard inaccessible elements. This rule is part of [`eslint-plugin-react-a11y`](https://www.npmjs.com/package/eslint-plugin-react-a11y) and provides LLM-optimized error messages with fix suggestions.
...
This rule helps ensure WCAG 2.1.1 compliance by enforcing: Prevent keyboard inaccessible elements
...
```tsx
// Violation of no-keyboard-inaccessible-elements
...
```tsx
// Compliant with no-keyboard-inaccessible-elements
// See rule source for specific examples
```
...
- **2.1.1 Keyboard**: Prevent keyboard inaccessible elements
