...
Validate ARIA property names. This rule is part of [`eslint-plugin-react-a11y`](https://www.npmjs.com/package/eslint-plugin-react-a11y) and provides LLM-optimized error messages with fix suggestions.
...
This rule helps ensure WCAG 4.1.1 compliance by enforcing: Validate ARIA property names
...
- **4.1.1 Parsing**: Validate ARIA property names
