...
> **Keywords:** label-has-associated-control, accessibility, ESLint rule, WCAG, a11y, React accessibility

Require labels to have associated controls. This rule is part of [`eslint-plugin-react-a11y`](https://www.npmjs.com/package/eslint-plugin-react-a11y) and provides LLM-optimized error messages with fix suggestions.
...
This rule helps ensure WCAG 1.3.1 compliance by enforcing: Require labels to have associated controls
...
```tsx
// Violation of label-has-associated-control
...
```tsx
// Compliant with label-has-associated-control
// See rule source for specific examples
```
...
- **1.3.1 Info and Relationships**: Require labels to have associated controls
