...
Require heading elements to have content. This rule is part of [`eslint-plugin-react-a11y`](https://www.npmjs.com/package/eslint-plugin-react-a11y) and provides LLM-optimized error messages with fix suggestions.
...
This rule helps ensure WCAG 1.3.1 compliance by enforcing: Require heading elements to have content
...
```tsx
// Violation of heading-has-content
...
```tsx
// Compliant with heading-has-content
// See rule source for specific examples
```
...
- **1.3.1 Info and Relationships**: Require heading elements to have content
