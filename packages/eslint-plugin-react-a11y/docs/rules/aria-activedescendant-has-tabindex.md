...
Require tabindex with aria-activedescendant. This rule is part of [`eslint-plugin-react-a11y`](https://www.npmjs.com/package/eslint-plugin-react-a11y) and provides LLM-optimized error messages with fix suggestions.
...
This rule helps ensure WCAG 4.1.2 compliance by enforcing: Require tabindex with aria-activedescendant
...
```tsx
// Violation of aria-activedescendant-has-tabindex
...
```tsx
// Compliant with aria-activedescendant-has-tabindex
// See rule source for specific examples
```
...
- **4.1.2 Name, Role, Value**: Require tabindex with aria-activedescendant
